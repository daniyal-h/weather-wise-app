...
public class WeatherJsonAdapterTest {
    ...
    private void validJsonParsing() {
        ...
        String[] expectedResponse1 = new String[] {"265.05", "258.05", "clear sky", "52", "5.81", "-18000", "1734869839", "1734903140", "n"};
        String[] expectedResponse2 = new String[] {"285.43", "284.75", "light rain", "78", "3.09", "-21600", "1734872799", "1734912243", "d"};
