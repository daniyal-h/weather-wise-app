...
public class WeatherJsonAdapterTest {
    ...
    private void validJsonParsing() {
        ...
        String validJSON2 = "{\"coord\":{\"lon\":-99.1277,\"lat\":19.4285},\"weather\":[{\"id\":500,\"main\":\"Rain\",\"description\":\"light rain\",\"icon\":\"10n\"}],\"base\":\"stations\",\"main\":{\"temp\":285.43,\"feels_like\":284.75,\"temp_min\":285.11,\"temp_max\":285.43,\"pressure\":1018,\"humidity\":78,\"sea_level\":1018,\"grnd_level\":765},\"visibility\":10000,\"wind\":{\"speed\":3.09,\"deg\":360},\"rain\":{\"1h\":0.25},\"clouds\":{\"all\":75},\"dt\":1734916894,\"sys\":{\"type\":2,\"id\":2097454,\"country\":\"MX\",\"sunrise\":1734872799,\"sunset\":1734912243},\"timezone\":-21600,\"id\":3530597,\"name\":\"Mexico City\",\"cod\":200}";

        String[] expectedResponse1 = new String[] {"265.05", "258.05", "clear sky", "52", "5.81", "-18000", "1734869839", "1734903140"};
        String[] expectedResponse2 = new String[] {"285.43", "284.75", "light rain", "78", "3.09", "-21600", "1734872799", "1734912243"};
